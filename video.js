...
function update_info_height_width() {
  ...
  info_height_width.innerHTML =
    window.player.width + " x " + window.player.height; //currentWidth();
}
...
function time_slider_changed() {
  ...
  window.player.currentTime =
    time_slider.valueAsNumber * window.player.duration;
...
window.player.onplay = function(e) {
...
window.player.ondurationchange = function() {
  update_info_duration();
};
